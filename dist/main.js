...
function getAddTaskForm(addTaskButton, section) {
  ...
  addTaskForm.querySelector(".submit-btn").addEventListener("click", () => {
    (0,_projectSection__WEBPACK_IMPORTED_MODULE_0__.addTaskToProjectSection)(addTaskForm, section);
  });
  return addTaskForm;
}
...
function addTodaySection(parent) {
  ...
  todayHeader.addEventListener("click", () =>
    (0,_todaySection__WEBPACK_IMPORTED_MODULE_3__["default"])(mainContainer, _storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].getTasksDueToday())
  );
...
function addProjects(projects, parent) {
  ...
  for (const project of projects) {
    ...
    projectTrashContainer.addEventListener("click", () => {
      _storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].removeProject(project);
      renderNavbar(_storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].getProjects());
    });
...
function Project(name) {
  ...
  const addTaskToSubsection = (subsection, newTaskInfo) => {
    const newTask = (0,_todo_js__WEBPACK_IMPORTED_MODULE_0__["default"])(
      newTaskInfo[0],
      newTaskInfo[1],
      newTaskInfo[2],
      newTaskInfo[3]
...
/* harmony export */   addTaskToProjectSection: () => (/* binding */ addTaskToProjectSection),
...
/* harmony import */ var _addTaskForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addTaskForm */ "./src/addTaskForm.js");
/* harmony import */ var _sectionForm_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sectionForm.js */ "./src/sectionForm.js");
...
function renderProjectSection(mainContainer, project) {
  ...
  sectionButton.addEventListener("click", () =>
    (0,_sectionForm_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_mainContainer).displayForm(project.getProjectName())
  );
...
const appendTask = (parent, task, section) => {
  ...
  taskButton.addEventListener("click", () => {
    _storedProjects__WEBPACK_IMPORTED_MODULE_0__["default"].removeTaskFromProjectSubsection(
  ...
  taskTrashContainer.addEventListener("click", () => {
    ...
    _storedProjects__WEBPACK_IMPORTED_MODULE_0__["default"].updateLocale();
    renderProjectSection(_mainContainer, _project);
  });
...
const appendAddButton = (parent, section) => {
  ...
  const addTaskForm = (0,_addTaskForm__WEBPACK_IMPORTED_MODULE_1__["default"])(buttonContainer, section);
...
const addTaskToProjectSection = (taskForm, section) => {
  ...
  _storedProjects__WEBPACK_IMPORTED_MODULE_0__["default"].addTaskToProjectSubsection(
    currentProject,
    section,
    taskTitle,
    taskDescription,
...
const displayEditTaskDialogue = (task) => {
  ...
  taskDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), "yyyy-MM-dd");
...
/* harmony import */ var _storedProjects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storedProjects */ "./src/storedProjects.js");
/* harmony import */ var _navbar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navbar.js */ "./src/navbar.js");
/* harmony import */ var _projectSection_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./projectSection.js */ "./src/projectSection.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((mainContainer) => {
  const displayForm = (projectName) => {
    ...
    submitButton.addEventListener("click", () => {
      _storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].addSubsectionToProject(newSectionName.value, projectName);
      sectionForm.replaceWith(sectionButton);
      (0,_projectSection_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
        mainContainer,
        _storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].getProject(projectName)
      );
    });
  };
  return { displayForm };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  ...
  function getStoredProjects() {
    ...
    if (localStorage.length === 0) {
      projects = { "My First Project": (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])("My First Project") };
      ...
      for (let projectName of Object.keys(localStorage)) {
        projects[projectName] = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])(projectName);
  ...
  for (let projectName in tasksDueToday) {
    for (let section in tasksDueToday[projectName]) {
      for (let task of tasksDueToday[projectName][section]) {
        ...
        taskTrashContainer.appendChild(taskTrash);
        taskTrashContainer.addEventListener("click", () => {
          _storedProjects__WEBPACK_IMPORTED_MODULE_1__["default"].removeTaskFromProjectSubsection(
            projectName,
            section,
            task.getTitle()
          );
...
function Todo(title, description, dueDate, priority) {
  ...
  const getDueDate = () => (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(_dueDate), "MMMM dd");
  const getPriority = () => _priority;
  const isDueToday = () => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(_dueDate);
  const toJSON = () => {
    return {
      title: _title,
      description: _description,
      date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(_dueDate, "yyyy-MM-dd"),
      priority: _priority,
    };
  };
  return {
